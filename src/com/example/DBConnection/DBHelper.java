...
public class DBHelper extends SQLiteOpenHelper{
	...
	Profile.COLUMN_NAME_GENDER + TEXT_TYPE + " )";
	/**
	...
	Workout.COLUMN_NAME_WORKOUT_TYPE + TEXT_TYPE + NOT_NULL_CONSTRAINT + COMMA_SEP +
	Workout.COLUMN_NAME_AVG_HEART_RATE + REAL_TYPE + " )";
	/**
